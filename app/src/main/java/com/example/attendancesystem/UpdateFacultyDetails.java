...
public class UpdateFacultyDetails extends Fragment {
    View view;
    DBHandler dbHandler;
    ...
    String faculty_first_nameVal,faculty_last_nameVal,faculty_addressVal,faculty_phone_noVal,faculty_emailVal,faculty_passwdVal,faculty_qualificationVal,idVal;
    MaterialButton update_faculty_btn,faculty_cancel_btn;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_update_faculty_details, container, false);
        ...
        faculty_first_nameVal=getArguments().getString("firstName");
        faculty_last_nameVal=getArguments().getString("lastName");
        faculty_addressVal=getArguments().getString("address");
        faculty_phone_noVal=getArguments().getString("phoneNo");
        faculty_emailVal=getArguments().getString("email");
        faculty_passwdVal=getArguments().getString("password");
        faculty_qualificationVal=getArguments().getString("qualification");
        idVal=getArguments().getString("id");
        faculty_first_name.setText(faculty_first_nameVal);
        faculty_last_name.setText(faculty_last_nameVal);
        faculty_address.setText(faculty_addressVal);
        faculty_phone_no.setText(faculty_phone_noVal);
        faculty_email.setText(faculty_emailVal);
        faculty_passwd.setText(faculty_passwdVal);
        faculty_qualification.setText(faculty_qualificationVal);
        update_faculty_btn=view.findViewById(R.id.update_faculty_btn);
        update_faculty_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if(first_name.isEmpty()){
                    ...
                    dbHandler.updateFacultyDetails(idVal,first_name,last_name,address,phone_no,email,password,qualification);
                    Toast.makeText(getActivity(), "Faculty Details Updated Successfully", Toast.LENGTH_SHORT).show();
